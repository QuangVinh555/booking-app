    ...
    <div className="fp">
        <div className="fpItem">
            ...
            <div className="fpTitles">
                <h1 className="fpName">Aparthotel Stare Miasto</h1>
                <h2 className="fpCity">Madrid</h2>
                <h2 className="fpPrice">Starting from $120</h2>
        ...
        <div className="fpItem">
            ...
            <div className="fpTitles">
                <h1 className="fpName">Aparthotel Stare Miasto</h1>
                <h2 className="fpCity">Austin</h2>
                <h2 className="fpPrice">Starting from $140</h2>
                <div className="fpRating">
                    <button>9.3</button>
                    <span>Excellent</span>
                </div>
        ...
        <div className="fpItem">
            ...
            <div className="fpTitles">
                <h1 className="fpName">Aparthotel Stare Miasto</h1>
                <h2 className="fpCity">Lisbon</h2>
                <h2 className="fpPrice">Starting from $99</h2>
                <div className="fpRating">
                    <button>8.8</button>
                    <span>Excellent</span>
                </div>
        ...
        <div className="fpItem">
            ...
            <div className="fpTitles">
                <h1 className="fpName">Aparthotel Stare Miasto</h1>
                <h2 className="fpCity">Berlin</h2>
                <h2 className="fpPrice">Starting from $105</h2>
                <div className="fpRating">
                    <button>8.9</button>
                    <span>Excellent</span>
                </div>
